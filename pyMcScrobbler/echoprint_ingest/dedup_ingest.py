...
sys.path.insert(0, "/media/data/stephane/Documents/Code/McScrobbler/echoprint-server/API")
import fp

_codegen_path = "/media/data/stephane/Documents/Code/McScrobbler/echoprint-codegen/echoprint-codegen"
